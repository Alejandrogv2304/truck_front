  ...
  return (
    <div className="bg-[#EDFAF2] font-ubuntu rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="flex items-center justify-items-start mb-2">
            ...
            >
              <FaToggleOn className="text-2xl cursor-pointer text-gray-600 hover:text-red-500 hover:scale-125 transition-all duration-200" />
            </button>
            ...
            >
              <MdEditSquare className="text-2xl cursor-pointer text-gray-600 hover:text-green-600 hover:scale-125 transition-all duration-200"/>
            </button>
