...
export default function ConductorCard({nombre,apellido,identificacion,estado, fecha_vinculacion,id_conductor, onDelete, onEdit, telefono}: ConductorCardProps) {
  return (
    <div className={`${estado === "activo" ? "bg-[#EDFAF2]" : "bg-slate-100"} font-ubuntu rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow duration-200 border-2 border-slate-100`}>
